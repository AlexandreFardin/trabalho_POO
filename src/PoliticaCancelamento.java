...
public class PoliticaCancelamento {
    ...
    public PoliticaCancelamento(String nomeRegra, String descricao, int prazoMinimoHoras, double taxaNoShow) throws Exception {
    ...
    public double calcularTaxa(Agendamento agendamento) {
        Date agora = new Date();
        Date dataAgendamento = agendamento.getDataHoraInicio();
        
        long diferencaMs = dataAgendamento.getTime() - agora.getTime();
        long diferencaHoras = diferencaMs / (1000 * 60 * 60);
