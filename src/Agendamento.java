...
public class Agendamento {
    ...
    public void setDataHoraInicio(LocalDateTime dataHoraInicio) throws Exception {
    ...
    public void setDataHoraFim(LocalDateTime dataHoraFim) throws Exception {
        if (dataHoraFim == null) {
    ...
    public Agendamento(
        ...
        if (Administrador.isFeriado(dataInicio)) {
    ...
    public void remarcar(LocalDateTime novaDataInicio, LocalDateTime novaDataFim) throws Exception {

        if (Administrador.isFeriado(novaDataInicio.toLocalDate())) {
    ...
    public void enviarNotificacao(String tipo) {
        ...
        Notificacao notificacao = new Notificacao(tipo, mensagem, LocalDateTime.now(), this);
